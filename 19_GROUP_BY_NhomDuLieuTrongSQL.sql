...
-- Hãy tính đơn giá trung bình theo mỗi nhà cung cấp sản phẩm.
...
-- Hãy cho biết giá vận chuyển thấp nhất và lớn nhất của các đơn hàng theo
-- từng thành phố và quốc gia khác nhau
